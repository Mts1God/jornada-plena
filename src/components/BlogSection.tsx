...
const posts = [
  {
    ...
    excerpt: "Muitas mulheres vivem no automático sem perceber que estão distantes de quem realmente são. Descubra os sinais e como voltar para si.",
    date: "15 Mar 2026",
  },
  {
    category: "Espiritualidade",
    title: "O poder do sagrado feminino na vida moderna",
    excerpt: "Como resgatar a sabedoria ancestral feminina e integrá-la ao seu dia a dia, encontrando equilíbrio entre o moderno e o sagrado.",
    date: "08 Mar 2026",
  },
  {
    category: "Autocuidado",
    title: "Rituais matinais que transformam sua energia",
    excerpt: "Pequenas práticas diárias podem mudar completamente a forma como você se sente. Conheça rituais simples e poderosos para começar bem o dia.",
    date: "01 Mar 2026",
  },
  {
    category: "Reflexão",
    title: "Vulnerabilidade como força: aprendendo a sentir",
    excerpt: "Ser vulnerável não é fraqueza. Descubra como abraçar suas emoções pode ser o caminho mais corajoso para uma vida plena.",
    date: "22 Fev 2026",
  },
];
      ...
      <div className="container mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-base font-body text-muted-foreground leading-relaxed">
            Artigos, reflexões e práticas para nutrir sua alma e iluminar seu caminho.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {posts.map((post, index) => (
            <article
              key={index}
              className="group bg-background rounded-2xl overflow-hidden border border-border/50 hover:shadow-lg transition-all duration-500 hover:-translate-y-1 cursor-pointer"
            >
